...
function getDateDetails(date) {
  ...
  // Перевіряємо, чи вхідне значення є об'єктом Date
  if (!(date instanceof Date) || isNaN(date)) {
    // Якщо вхідне значення не є об'єктом Date, повертаємо рядок з помилкою
    return "Помилка: вхідне значення має бути об'єктом Date";
  }

  // Отримуємо рік з об'єкта Date
  const year = date.getFullYear();
  // Отримуємо місяць з об'єкта Date. Зауважте, що місяці в JavaScript починаються з 0, тому може знадобитися коригування в інших частинах коду.
  const month = date.getMonth();
  // Отримуємо день місяця з об'єкта Date
  const day = date.getDate();

  // Повертаємо об'єкт з деталями про рік, місяць і день
...
function setDateDetails(date, isoString) {
  ...
  // Перевіряємо, чи вхідне значення є об'єктом Date
  if (!(date instanceof Date) || isNaN(date)) {
    // Якщо date не є об'єктом Date, повертаємо рядок з помилкою
    return "Помилка: вхідне значення має бути об'єктом Date";
  }
  ...
  if (isNaN(parsedDate)) {
    // Якщо вхідний рядок не є валідним, повертаємо рядок з помилкою
...
function dateToUTC(date) {
  ...
  // Перевірка, чи вхідне значення є об'єктом Date
  if (!(date instanceof Date) || isNaN(date)) {
    // Якщо date не є об'єктом Date, повертаємо рядок з помилкою
    return "Помилка: вхідне значення має бути об'єктом Date";
  }
...
function nextNewYear() {
  ...
  // Створюємо змінну для поточної дати
  const currentDate = new Date();
  // Визначення поточного року
  const currentYear = currentDate.getFullYear();
  // Визначення дати наступного Нового року
  const nextYear = new Date(currentYear + 1, 0, 1);
  // Визначення різниці в мілісекундах до наступного Нового року
...
function addDays(date, days) {
  ...
  if (typeof days !== "number" || isNaN(days)) {
    // Якщо days не є числом, функція поверне рядок з помилкою та undefined
...
function getAge(birthDate) {
  ...
  if (!(birthDate instanceof Date) || isNaN(birthDate)) {
    // Якщо birthDate не є об'єктом Date, повертаємо рядок з помилкою
    return "Помилка: вхідне значення має бути об'єктом Date";
  }
...
function compareDates(date1, date2) {
  ...
  if (
    ...
    // Якщо date1 або date2 не є об'єктами Date, повертаємо рядок з помилкою
    return "Помилка: вхідне значення має бути об'єктом Date";
  }
...
function getDaysDifference(startDate, endDate) {
  ...
  if (
    ...
    // Якщо startDate або endDate не є об'єктами Date, повертаємо рядок з помилкою
    return "Помилка: вхідне значення має бути об'єктом Date";
  }
